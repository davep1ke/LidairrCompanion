...
namespace LidarrCompanion.Helpers
{
    public class LidarrManualImportFile : INotifyPropertyChanged
    {
        ...
        // See LidarrArtistReleaseTrack.Clone() - same reasoning, a cached entry shouldn't be
        // handed out as a shared mutable instance.
        public LidarrManualImportFile Clone() => new()
        {
            Path = Path,
            Name = Name,
            Id = Id,
